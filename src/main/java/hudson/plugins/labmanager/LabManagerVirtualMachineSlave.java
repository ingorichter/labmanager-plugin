...
public class LabManagerVirtualMachineSlave extends Slave {
	...
	private final boolean updateNodeHostAddress;
	...
	public LabManagerVirtualMachineSlave(String name, String nodeDescription,
            ...
            List<?extends NodeProperty<?>> nodeProperties,
					...
					boolean launchSupportForced, String launchDelay, boolean updateNodeHostAddress)
					throws Descriptor.FormException, IOException {
		super(name, nodeDescription, remoteFS, numExecutors, mode, labelString,
						new LabManagerVirtualMachineLauncher(delegateLauncher, lmDescription,
						vmName, idleOption,
						launchSupportForced ? Boolean.TRUE : null, launchDelay, updateNodeHostAddress),
						retentionStrategy, nodeProperties);
		this.lmDescription = lmDescription;
		this.vmName = vmName;
		this.idleOption = idleOption;
		this.launchDelay = launchDelay;
		this.updateNodeHostAddress = updateNodeHostAddress;
	}
	...
	public boolean isUpdateNodeHostAddress() {
		return ((LabManagerVirtualMachineLauncher) getLauncher()).isUpdateHostAddress();
	}

	public void setUpdateNodeHostAddress(boolean updateNodeHostAddress) {
		((LabManagerVirtualMachineLauncher) getLauncher()).setUpdateHostAddress(updateNodeHostAddress);
	}
